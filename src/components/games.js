const games = [
  ...
  },
  {
    ...
    img:'prince_of_persia_the_lost_crown.jpg',
    valoration: '7.5',
    description: 'La saga Prince of Persia vuelve a la carga con Prince of Persia: The Lost Crown, un nuevo título de una de las franquicias más queridas de Ubisoft que lo cierto es que llevaba muchos años (demasiados) sin dar señales de vida. En esta ocasión, el famoso PoP que creó originalmente Jordan Mechner hace más de treinta años, retorna convertido en un metroidvania en 2D de dificultad endiablada, una aventura de acción y plataformas que permitirá al usuario viajar por la mitología persa y manipular los límites del espacio y el tiempo.',
    version: 1.01,
    size: '13.7GB',
    category: 'aventura'
  },
  {
    ...
    valoration: '8.5',
    description: 'Con MLB® The Show™ 23 estarás más cerca de vivir tus sueños en el campo de béisbol. Sorprende a todos en The Show™ con tus jugadores favoritos, tus rivales predilectos y tus mejores momentos en la MLB®.',
    version: 1.21,
    size: '67GB',
    category: 'deporte'
  },
